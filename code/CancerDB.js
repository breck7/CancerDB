...
class TreatmentPageTemplate {
  ...
  get quickLinks() {
    ...
    const links = {
      ...
      smart_display: file.get("youTubeChannel"),
      linkedin: file.get("linkedin"),
      facebook: file.get("facebook"),
      instagram: file.get("instagram"),
      pinterest: file.get("pinterest"),
      wolframAlpha: file.get("wolframAlpha"),
      edit: this.sourceUrl
    }
